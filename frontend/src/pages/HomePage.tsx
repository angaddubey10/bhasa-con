      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center">
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
            Welcome to Bhasa Con
          </h1>
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Connect with language learners worldwide. Share experiences, practice together, 
            and build a global community of linguistic diversity.
          </p>
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <p className="text-gray-600">
              Practice languages with native speakers and fellow learners
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">
              Share resources, tips, and support each other's journey
            </p>
          </div>
